...
class import_Gromos_Distance_Restraints(_Importer):
...
class import_Gromacs_Distance_Restraints(_Importer):
...
class import_JSON_Distance_Restraints(_Importer):

    def __init__(self, all_atoms: t.List[u.Atom]):
        """
                This class contains functions, for reading in JSON Files generated by restraintmaker.
